...
public class Initializer {
    ...
    public void setupDemoPhones(){
        phoneService.save( new Phone(10L , "Iphone XS max" , "images/1.png" , "xxxx xxxx xxxx xxxx" , 3));

        phoneService.save( new Phone(110L , "Iphone X pro max" , "images/2.png" , "xxxx xxxx xxxx xxxx" , 4));

        phoneService.save( new Phone(2110L , "Iphone 11 pro max " , "images/3.png" , "xxxx xxxx xxxx xxxx" , 5));

        phoneService.save( new Phone(1980L , "Iphone 12 pro max +" , "images/4.png" , "xxxx xxxx xxxx xxxx" , 2));

        phoneService.save( new Phone(159L , "Iphone XR" , "images/5.png" , "xxxx xxxx xxxx xxxx" , 3));

        phoneService.save( new Phone(219L , "Iphone 8 +" , "images/6.png" , "xxxx xxxx xxxx xxxx" , 5));

        phoneService.save( new Phone(975L , "Iphone 6 +" , "images/1.png" , "xxxx xxxx xxxx xxxx" , 2));

        phoneService.save( new Phone(749L , "Iphone 7" , "images/2.png" , "xxxx xxxx xxxx xxxx" , 3));

        phoneService.save( new Phone(1349L , "Iphone 7+" , "images/3.png" , "xxxx xxxx xxxx xxxx" , 4));

        phoneService.save( new Phone(8888850L , "Iphone pro max +" , "images/4.png" , "xxxx xxxx xxxx xxxx" , 2));
